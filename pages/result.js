...
export default function ResultPage() {
  ...
  const descriptionMap = {
    감정: {
      ...
      text: [
        ...
        `${userInfo.mbti} 성향과 결합될 경우 감정과 논리를 동시에 고려하려 하지만, 갈등 순간에는 마음의 울림에 더 집중하는 경향이 나타납니다.`,
      ],
      improve: [
    ...
    문제해결: {
      ...
      text: [
        ...
        `${userInfo.mbti} 성향과 결합될 경우 더욱 빠르게 상황 판단을 하고 명확한 해결책을 제시하려는 성향이 강화됩니다.`,
    ...
    관계: {
      ...
      text: [
        ...
        `${userInfo.mbti} 성향과 결합되면 타인의 마음을 세심히 살피는 능력이 강해지지만, 스스로를 뒤로 미루는 경우도 생길 수 있습니다.`,
    ...
    회피: {
      ...
      text: [
        ...
        `${userInfo.mbti} 성향과 결합되면, 갈등을 해결보다는 안정과 거리 두기를 우선하게 됩니다.`,
  ...
  const info = descriptionMap[mainType];
